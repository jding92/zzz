...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
     ...
     *
     * It should look like:  http://api.translink.ca/rttiapi/v1/stops/[stop number]/estimates?apikey=[APIKey]
     */
    protected URL getURL() throws MalformedURLException {
        String request;

        request = "http://api.translink.ca/rttiapi/v1/stops/" + stop.getID()
