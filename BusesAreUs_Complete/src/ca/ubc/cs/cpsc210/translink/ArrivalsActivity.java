...
public class ArrivalsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        int stopNumber = i.getIntExtra(getString(R.string.stn_name_key), 99999);
        Stop stop = StopManager.getInstance().getStopWithId(stopNumber);
        setTitle(stop.getID() + " " + stop.getName());
